...
import { enjoy, meal, starter } from "../assets/Index";
      ...
      <div className="container__home">
        <div className="container__home__section">
          <img
            ...
            className="container__home__section__svg"
          />
          <Jumbotron />
          <Explore />
        </div>
        ...
        <div className="container__home__explore__content__entry">
          ...
          <div className="container__home__explore__content__entry__overlay">
            ...
            <div className="container__home__explore__content__entry__overlay__info">
              ...
              iLorem Ipsum has been the iLorem Ipsum is simply dummy text of the
